...
def prepare_owner_instruction(task_dir: Path) -> Path:
    ...
    write_text(
        ...
        "Before writing code, use this order: do nothing; remove or disable; configure "
        "or reuse; simplify; only then add the smallest necessary code. Briefly justify "
        "why the observed gap could not be closed by an earlier option.\n\n"
